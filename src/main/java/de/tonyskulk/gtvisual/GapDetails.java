...
public class GapDetails {
  ...
  public GapDetails(BigDecimal gapValue, BigDecimal gapPercent, BigDecimal lowerPrice,
      BigDecimal higherPrice, BigDecimal volume) {
  ...
  public String toString() {
    return "GapDetails [gapValue=" + gapValue + ", gapPercent=" + gapPercent + ", lowerPrice="
        + lowerPrice + ", higherPrice=" + higherPrice + ", volume=" + volume + "]";
  }
